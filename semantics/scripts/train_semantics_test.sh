...
# module load cudnn
# source /cs/snapless/oabend/fogrid/envs/tf15/bin/activate

# module load tensorflow
#module load tensorflow/2.0.0
#source /cs/snapless/oabend/borgr/nematus/envs/tg/bin/activate
...
script_dir=/cs/snapless/oabend/fogrid/nematus/semantics
echo "script_dir is ${script_dir}"
main_dir=$script_dir/../
echo "main_dir is ${main_dir}"
nematus_home=$script_dir/../
data_dir=$script_dir/data
#data_dir=/cs/snapless/oabend/fogrid/nematus/semantics/data
...
#src_train=$data_dir/UD/newstest2013.unesc.tok.tc.bpe.trns1.en
src_train=$data_dir/newstest2013.unesc.tok.tc.bpe.de
trg_train=$data_dir/newstest2013_en_ucca_transitions.txt
...
python $nematus_home/nematus/train.py \
    ...
    --beam_size 8 \
    --parent_head \
    --valid_remove_parse &> /cs/snapless/oabend/fogrid/nematus/semantics/slurm/out$(date "+%Y.%m.%d-%H.%M.%S") &
